  ...
  return (
    <section id="contact" className="py-[82px] max-sm:py-[70px]">
      <div className="w-[min(1200px,calc(100%-48px))] mx-auto max-sm:w-[min(100%-24px,1200px)]">
        <ScrollReveal>
          <div className="bg-[var(--color-ink)] p-10 sm:p-12 grid grid-cols-[1fr_auto] items-center gap-10 max-md:grid-cols-1 border border-white/10">
            <div>
